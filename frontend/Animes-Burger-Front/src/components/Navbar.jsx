        ...
        <div className={`relative ${navBgClass} h-20`}> {/* */}
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-full">
                <div className="relative flex h-full items-center justify-between">
                    ...
                    <div className="flex items-center h-full">
                        ...
                        {/*Logo e Título*/}
                        <Link to="/" className="flex shrink-0 items-center h-full ml-4 sm:ml-0 hover:opacity-90 transition-opacity">
                            <img
                                src={LogoImage}
            ...
            <div className={`sm:hidden ${isMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu">
                <div className="space-y-1 px-2 pt-2 pb-3">
                    ...
                    {/*Opções de Conta/Login no Mobile */}
                    {token ? (
                        <>
